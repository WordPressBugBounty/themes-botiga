...
function botiga_dashboard_get_setting_icon( $slug ) {
	...
	switch ( $slug ) {
		...
		case 'ai-mcp':
			$icon = '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				<rect x="5" y="6" width="14" height="12" rx="2" stroke="#1E1E1E" stroke-width="1.5"/>
				<path d="M12 3V6M12 18V21M2 12H5M19 12H22M9 11H9.01M15 11H15.01M9 15H15" stroke="#1E1E1E" stroke-width="1.5" stroke-linecap="round"/>
			</svg>';
			break;
